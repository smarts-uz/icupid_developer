...
<?php  print $tdata[1]["contents"]; ?>
				...
				<h1 style="text-align: center; border-bottom: 0px;">
					iCupid Dating Software <?php echo $version; ?>				</h1>
...
<h1>
				...
				<div class="install-text">
					...
					<p>
						Failure to do so could lead to your iCupid Dating Software installation not functioning correctly.					</p>
				  <div class="ctr"></div>
				</div>
				...
				<div class="install-form">
					<div class="form-block">
						...
						<tr>
							...
							<td align="left">
								<?php echo phpversion() < '5.0' ? '<b><font color="red">No</font></b>' : '<b><font color="green">Yes</font></b>';?>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td align="left">
							<?php echo  (@extension_loaded('ioncube') || @extension_loaded('ionCube Loader')) ? '<b><font color="green">Available</font></b>' : '<b><font color="red">Unavailable</font></b>';?>
