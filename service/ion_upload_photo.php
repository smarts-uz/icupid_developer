...
$arrData = array();
    ...
    if ($_FILES) {
      ...
      //imagecreatefromstring($imgString);
      ...
      VALUES ('".$_POST['aid']."', '".$_POST['uid']."' , '".DATE_NOW."', '".$_POST['title']."' ,'".$_POST['desc']."' ,'".$imgsPath."', '".APPROVE_FILES."', 'photo')");
      ...
      // $arrData[0]->pid = $pids;
      // $arrData[0]->bigimage =  DB_DOMAIN.'inc/tb.php?src='.$imgsPath;
      echo json_encode($pids.'*'.DB_DOMAIN.'inc/tb.php?src='.$imgsPath, JSON_UNESCAPED_SLASHES);
