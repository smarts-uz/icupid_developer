...
$DB->Insert("INSERT INTO `members_meetme` ( `uid` , `to_uid` , `date` , `approved`)
VALUES ('".$iId."', '".$rId."', '".DATE_NOW."', '".$msg."')");

if($msg == 'yes'){

  $values['email'] = $remail;
  $values['username'] = $rname;
  $values['meet_me_username'] = $uname;
  $values['meet_me_profile_link'] = DB_DOMAIN.$uname;

  SendTemplateMail($values, 64);
}
