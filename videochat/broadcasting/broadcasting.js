...
var projectRootUrl = 'http://advandate.biz/videochat/';

function Z5Broadcasting()
{
	this.build = '4.160518';
	...
	{
		var flashvars = {userID:userID};
        var params = {allowscriptaccess:'always', allowfullscreen:true};
		var attributes = {};
		swfobject.embedSWF(projectRootUrl + "broadcasting/swf/broadcasting.swf?build=" + this.build,
				"z5_broadcasting_swf_" + userID, "206", "176", this.flashVersion, null,
				flashvars, params, attributes);

		document.write(this.MakeSwfHolder("z5_broadcasting_swf_" + userID));
	}
...
var z5broadcasting = new Z5Broadcasting();
