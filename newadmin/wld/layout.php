...
<?php  print Header_LoadCSS($_REQUEST['n'], $_GET['p']) ?>
  ...
  <link rel="stylesheet" href="inc/css/reset.css"> <!-- CSS reset -->
	...
	<link rel="stylesheet" href="wld/css/custom.css"> <!-- Resource style -->

	<script src="inc/js/modernizr.js"></script> <!-- Modernizr -->

	<script src="wld/js/wld_ajax.js"></script> <!-- Modernizr -->

</head>



<body onLoad="<?php print WLD_Header_LoadOn($_REQUEST['n'], $_GET['p']) ?>">
