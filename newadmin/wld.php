...
require_once "wld/config.php";

require_once "../inc/config.php";
require_once "inc/func/admin_globals.php";
require_once "wld/func/wld_admin_globals.php";
require_once("../plugins/config_plugins.php" );


if(!in_array('wld',$PLUGINS_PAGES)){ ?>
	<h1>Access Denied</h1>
	<h2>iCupid WLD Network plugin is either not activated or not installed properly.</h2>
	<p>Please contact Advandate support if you are facing any problem in iCupid WLD Network plugin.</p>
...
$PageLink = "wld.php";
$PageLang = $admin_layout_page12;

require_once "wld/layout.php";
############################################################
#################### OPERATIONS ############################
if(ADMIN_DEMO != "yes"){
if(isset($_POST['do'])){
