...
<? } ?>
        ...
        <tr>
          <td ><strong>Display Meet Me Feature at Overview Page </strong></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="dmeetme" value="1" <?php if(D_MEET_ME ==1){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="dmeetme" value="0" <?php if(D_MEET_ME ==0){ print "checked"; } ?>></td>
        </tr>
        <tr>
          <td ><strong>Display Near Me Feature at Overview Page </strong></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="dnearme" value="1" <?php if(D_NEAR_ME ==1){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="dnearme" value="0" <?php if(D_NEAR_ME ==0){ print "checked"; } ?>></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
          <td><b>Display Sidebar Online </b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="psidebar" value="1" <?php if(D_SIDEBARONLINE ==1){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="psidebar" value="0" <?php if(D_SIDEBARONLINE ==0){ print "checked"; } ?>></td>
        </tr> 
        <tr>
          <td><b>Display Featured Members Area </b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="pfeaturedmemberarea" value="1" <?php if(D_FEATUREDMEMBERTOP2 ==1){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="pfeaturedmemberarea" value="0" <?php if(D_FEATUREDMEMBERTOP2 ==0){ print "checked"; } ?>></td>
        </tr> 
        <?/*</tr>
          <td><b>Display FlashCom Chat </b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="pflashcomchat" value="1" <?php if(D_FLASHCOM_CHAT ==1){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="pflashcomchat" value="0" <?php if(D_FLASHCOM_CHAT ==0){ print "checked"; } ?>></td>
        </tr>*/ ?>
        <tr>
          <td><b>Display Compare Profile</b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="pProfileCompare" value="yes" <?php if(D_PROFILE_COMPARE == 'yes'){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="pProfileCompare" value="no" <?php if(D_PROFILE_COMPARE == 'no'){ print "checked"; } ?>></td>
        </tr> 

        <tr>
          <td><b>Display Profile Compatibility Quiz</b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="pCompatibilityQuiz" value="yes" <?php if(D_COMPATIBILITY_QUIZ == 'yes'){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="pCompatibilityQuiz" value="no" <?php if(D_COMPATIBILITY_QUIZ == 'no'){ print "checked"; } ?>></td>
        </tr> 

        <tr>
          <td><b>Display Quick Link Box</b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="pQuickLinkBox" value="yes" <?php if(D_QUICK_LINK_BOX == 'yes'){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="pQuickLinkBox" value="no" <?php if(D_QUICK_LINK_BOX == 'no'){ print "checked"; } ?>></td>
        </tr> 

        <tr>
          <td><b>Display Breadcrumbs</b></td>
          <td align="center" bgcolor="#E4FED6"><input type="radio" name="pBreadcrumbs" value="yes" <?php if(D_BREADCRUMBS == 'yes'){ print "checked"; } ?>></td>
          <td align="center" bgcolor="#efefef"><input type="radio" name="pBreadcrumbs" value="no" <?php if(D_BREADCRUMBS == 'no'){ print "checked"; } ?>></td>
        </tr> 
...
?>
	<p id='TopCommentsBox'><img src='inc/images/icons/help.png' align='absmiddle' />  The thumbnails below are used to replace member photos if they havent yet added a photo to their account. Thumbnails MUST be .JPG format and 96x96 in dimentions.</p>
		...
		<ul class="form table_set_res"><div class="box_body">
...
<ul class="form"><div class="box_body">
	...
	<li><label >Pagination/Dynamic</label>
		      <select name="pd" style="width:100px;" class="input">
					<option value="pagination" <?php if(MATCH_PD =='pagination'){ print "selected"; } ?>>Pagination</option>
					<option value="dynamic" <?php if(MATCH_PD =='dynamic'){ print "selected"; } ?>>Dynamic</option>
		</select>
		</li>
</div></ul>
...
<a href="https://www.google.com/recaptcha/admin">https://www.google.com/recaptcha/admin</a></p>
	...
	<ul class="form"><div class="box_body">
		...
		<li><label>reCaptcha Site Key</label><input name="recappid" type="text" class="input" value="<?=reCAPTCH_APP_ID ?>">
      <div class="tip">Enter the Google reCaptcha Site key</div>
    </li>

		<li>
      <label>reCaptcha Secret Key</label><input name="recsecret" type="text" class="input" value="<?=reCAPTCH_SECRET ?>">
      <div class="tip">Enter the Google reCaptcha Secret key</div>
    </li>
...
<a href="http://developers.facebook.com/">http://developers.facebook.com/</a></p>
	...
	<ul class="form"><div class="box_body">
      ...
      <input name="fbappid" type="text" class="input" value="<?=FACEBOOK_APP_ID ?>">
      <div class="tip"> Signup using the link below: <a href="https://developers.facebook.com" target="_blank">https://developers.facebook.com</a> and copy Facebook app id from facebook developer account and paste here.</div>
    </li>

		<li>
      <label>Facebook APP Secret</label>
      <input name="fbsecret" type="text" class="input" value="<?=FACEBOOK_SECRET ?>">
      <div class="tip">Enter the facebook app secret above.</div>
    </li>
	
		<li>
      <label>Use Facebook Photo: </label>
  ...
  <p id='TopCommentsBox'><img src='inc/images/icons/help.png' align='absmiddle'/>  Use the following keys to show the map on the user as well as admin side. You will need to go the <a href="https://console.developers.google.com" target="_blank">Google Console Developers</a> site to register your website </p>
  
  <ul class="form">
    <div class="box_body">
      <input type="hidden" name="pkey" value="<?=MAPS_ID ?>">
      <? /*<li><label>Maps License Key:</label><input name="pkey" type="text" value="<?=MAPS_ID ?>" class="input" size="50"></li>*/ ?>

      <li>
        <label>Google Map API Key:</label>
        <input name="gkey" type="text" value="<?=GOOGLE_MAPS_KEY ?>" class="input" size="50">
        <div class="tip">Signup using the link below: <a href="https://developers.google.com/maps/" target="_blank">https://developers.google.com/maps/</a></div>
      </li>
    </div>
  </ul>

  <p id='TopCommentsBox'><img src='inc/images/icons/help.png' align='absmiddle'/>  Use the following keys to use Google Translate feature in site. You will need to go to <a href="https://cloud.google.com/translate/" target="_blank">https://cloud.google.com/translate/</a> to get your Google Translate key </p>
    
  <ul class="form">
    <div class="box_body">
      <li>
        <label>Google Translate API Key:</label>
        <input name="gtranslate" type="text" value="<?=GOOGLE_TRANSLATE_KEY ?>" class="input" size="50">
        <div class="tip">Signup using the link below: <a href="https://cloud.google.com/translate/" target="_blank">https://cloud.google.com/translate/</a></div>
      </li>
    </div>
  </ul>

  <p id='TopCommentsBox'><img src='inc/images/icons/help.png' align='absmiddle'/>  Use the following keys to make Google Signin feature active in your site. You will need to go to <a href="https://developers.google.com/identity/sign-in/web/devconsole-project" target="_blank">https://developers.google.com/identity/sign-in/web/devconsole-project/</a> to create Google Signin key and secret. </p>
    
  <ul class="form">
    <div class="box_body">
      <li><label>Google Signin API Key:</label>
        <input name="gsigninkey" type="text" value="<?=GOOGLE_SIGNIN_KEY?>" class="input" size="50">
        <div class="tip">Signup using the link below: <a href="https://developers.google.com/identity/sign-in/web/devconsole-project" target="_blank">https://developers.google.com/identity/sign-in/web/devconsole-project/</a></div>
      </li>

      <li>
        <label>Google Signin Secret Key:</label>
        <input name="gsigninsecret" type="text" value="<?=GOOGLE_SIGNIN_SECRET?>" class="input" size="50">
        <div class="tip"></div>
      </li>
    </div>
  </ul>

  <p id='TopCommentsBox'><img src='inc/images/icons/help.png' align='absmiddle'/>  Use the following keys to make Signin with Twitter feature active in your site. You will need to go to <a href="https://apps.twitter.com/" target="_blank">https://apps.twitter.com</a> to create Twitter Signin key and secret.  </p>
  

  <ul class="form">
    <div class="box_body">
      <li><label>Twitter Login API Key:</label>
        <input name="tsigninkey" type="text" value="<?=TWITTER_SIGNIN_KEY?>" class="input" size="50">
        <div class="tip">Signup using the link below: <a href="https://apps.twitter.com/" target="_blank">https://apps.twitter.com</a> to get API key and API secret</div>
      </li>

      <li><label>Twitter Login API Secret:</label>
        <input name="tsigninsecret" type="text" value="<?=TWITTER_SIGNIN_SECRET?>" class="input" size="50">
        <div class="tip">Signup using the link below: <a href="https://apps.twitter.com/" target="_blank">https://apps.twitter.com</a> to get API key and API secret</div>
      </li>
  ...
  <input name="submit2" type="submit" class="MainBtn" value="<?=$admin_button_val[8] ?>">
	...
	<?php /*<p id='TopCommentsBox'><img src='inc/images/icons/help.png' align='absmiddle' />  The <b>Youtube API</b> built into the software allows you to display thousands of youtube videos on your video page making your website appear more busy. You can get a free API ID from the website below; <a href="http://code.google.com/apis/youtube/dashboard/" target="_blank">http://code.google.com/apis/youtube/dashboard/</a></p>
...
<form method="post" action="settings.php" enctype="multipart/form-data">
  ...
  <input type="hidden" name="p" value="op" class="hidden">	
	...
	<ul class="form"><div class="box_body">
 	  ...
 	  <li>
      <label><?=$admin_settings_extra[25] ?></label>
      <select name="maintenance" style="width:100px;" class="input">
        <option value="yes" <?php if(WEBSITE_DEMO=="yes"){ print "selected";} ?>><?=$admin_selection[1] ?></option>
        <option value="no" <?php if(WEBSITE_DEMO=="no"){ print "selected";} ?>><?=$admin_selection[2] ?></option>
      </select>
      <div class="tip"><?=$admin_settings_extra[26] ?></div>
    </li>		

    <li>
      <label>Registration</label>
      <select name="d_registration" style="width:100px;" class="input">
        <option value="default" <?php if(D_USER_REGISTRATION == "default"){ print "selected";} ?>>Default</option>
        <option value="sliding" <?php if(D_USER_REGISTRATION == "sliding"){ print "selected";} ?>>Sliding</option>
      </select>
      <div class="tip">Above option will change the view of Registration page.</div>
    </li>

    <li>
      <label>Use Header</label>
      <select name="d_user_header" class="input">
        <option value="yes" <?php if(D_USER_HEADER == "yes"){ print "selected";} ?>>Yes</option>
        <option value="no" <?php if(D_USER_HEADER == "no"){ print "selected";} ?>>No</option>
      </select>
      <div class="tip">Select "Yes", if you want to keep header at user end, otherwise select "No".</div>
    </li>
    ...
    <li style="float: left;">
      ...
      <input name="bg_image_registration" class="input" type="file">
      <div class="tip">&nbsp;</div>
    </li>
      ...
      if(file_exists($root.'/images/'.D_USER_REGISTER_BACKGROUND_IMAGE)){
        ...
        echo "<li id='del-image-result' class='bg-reg-image' style='float: left; width: 200px; clear: none; margin-left: 50px !important; position: relative'> <img src='/images/".D_USER_REGISTER_BACKGROUND_IMAGE."'> <input type='button' value='Delete' class='del-btn' onclick='eMeetingDeleteRegBgImage();'></li>";
      }
      ?>
    ...
    ?>  
    <li>
      <label>Use Footer</label>
      <select name="d_user_footer" class="input">
        <option value="yes" <?php if(D_USER_FOOTER == "yes"){ print "selected";} ?>>Yes</option>
        <option value="no" <?php if(D_USER_FOOTER == "no"){ print "selected";} ?>>No</option>
      </select>
      <div class="tip">Select "Yes", if you want to keep footer at user end, otherwise select "No".</div>
    </li>
    <li>
      <label>Unaccepted Usernames</label>
      <input name="blockusernames" type="text" value="<?=BLOCK_USERNAMES?>" class="input" size="80">
      <div class="tip">Seperate usernames that you dont want members to use with a comma.</div>
    </li>


    <li>
      <label><?=$admin_settings_extra[43] ?>:</label>
      <select name="zdate" style="width:100px;" class="input">
        ...
        <option value="m-d-Y" <?php if(DATE_DISPLAY_FORMAT== "m-d-Y"){ print "selected";} ?>>m-d-Y</option>
		  ...
		  <div class="tip"><?=$admin_settings_extra[44] ?></div>
    </li>
	  ...
	  <li>
      <label ><?=$admin_settings_extra[49] ?>:</label>
      <select name="seof" style="width:100px;" class="input">
        <option value="1" <?php if(D_MOD_WRITE==1){ print "selected";} ?>><?=$admin_selection[1] ?></option>
        <option value="0" <?php if(D_MOD_WRITE==0){ print "selected";} ?>><?=$admin_selection[2] ?></option>
      </select>
      <div class="tip"><?=$admin_settings_extra[50] ?>.</div>
    </li>
		
    <li>
      <label><?=$admin_settings_extra[53] ?></label><select name="flag" style="width:100px;" class="input"><option value="1" <?php if(D_FLAGS=="1"){ print "selected";} ?>><?=$admin_selection[1] ?></option><option value="0" <?php if(D_FLAGS=="0"){ print "selected";} ?>><?=$admin_selection[2] ?></option></select><div class="tip"><?=$admin_settings_extra[54] ?>.</div></li>
		

	  <li>
      <label><?=$admin_settings_extra[55] ?></label>
      ...
      <div class="tip">Select the affiliate currency.</div>
    </li>		
	...
	<li><label>Copyright Text</label><input type="text" value="<?=D_CCTEXT ?>" name="cctext" class="input" style="width:550px;"><div class="tip">Enter your copyright text above to display on your website footer.</div></li>
      ...
      <select name="header_layout" style="width:100px;" class="input">
        <option value="boxed" <?php if(D_HEADER_LAYOUT == 'boxed'){ print "selected";} ?>>Boxed</option>
        <option value="full_width" <?php if(D_HEADER_LAYOUT == 'full_width'){ print "selected";} ?>>Full Width</option>
      </select>
      <div class="tip">If you selects “Boxed” then it will reduce the
size of the widthof header to the same width as the bottom(content) frame and if you selects “Full Width” then the size of the header will get equal to the width as the screen.</div>
    </li>    
 
    <li>
      <label>Font</label>
      <input name="g_font_familty" style="width:200px;" value="<?=D_FONT_FAMILY?>" class="input">
      <div class="tip">Type the correct Google Font name here and that font will be applied to the whole website.</div>
    </li>    
    ...
    <li>
      <label> Featured Members</label>
      <input type="text" name="featuredMemberNum" class="input" value="<?=D_FEATURED_MEMBER_NUM?>">
      <div class="tip">How many featured members you want to show in your featured member area.</div>
    </li>
      
    <li>
      <label> Featured Members (Gender)</label>
      <select name="featuredMemberGender" class="input">
        <option value="opposite" <?=(D_FEATURED_MEMBER_GENDER == 'opposite') ? "selected" : ""?>>Opposite</option>
        <option value="same" <?=(D_FEATURED_MEMBER_GENDER == 'same') ? "selected" : ""?>>Same</option>
        <option value="match" <?=(D_FEATURED_MEMBER_GENDER == 'match') ? "selected" : ""?>>Match Settings</option>
      </select>
      <div class="tip">What type of gender you want to show in featured member area.</div>
    </li>
