...
$admin_layout_page01 = array(
	...
	"backup" => "DB zapasowa",
		...
		"backup_?" => "Wybierz jeden lub więcej z poniższych tabelach do tworzenia kopii zapasowych bazy danych. Zdecydowanie zaleca się korzystanie z hostingu funkcje tworzenia kopii zapasowych bazy danych, aby zapewnić obszar otrzymaniu wszystkich danych.",
	
	"license" => "Klucz licencyjny",
 
		"license_*" => "Klucz licencyjny",
		"license_?" => "Poniżej wymienione są klucze licencyjne seryjne, należy wziąć je podczas edycji w celu zapewnienia, że są poprawne. Można je znaleźć w AdvanDate.com w Mojej obszarze Konta."
);

$admin_layout_page02 = array(


	"adminmsg" => "Ogłoszenie Site",
 
		"adminmsg_*" => "Ogłoszenie Site",
		"adminmsg_?" => "Wpisz wiadomość w polu poniżej i za każdym razem loguje się na swoje konto członkowskie komunikat będzie wyświetlany do nich. To jest dobre dla pokazano ogłoszeń dotyczących usług lub zmiany strony internetowej.",
...
$admin_layout_page8 = array(
	...
	"" => "Web Site Fields",
		...
		"fieldlist_*" => "Lista przedmiotów Box",

		"fieldedit_*" => "Edytuj Tytuł",

		"fieldeditmove_*" => "Przenieś pole do innej grupy",
