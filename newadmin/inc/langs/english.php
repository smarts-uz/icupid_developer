...
$admin_layout_page1 = array(
	...
	"mobileserver" => "Mobile Admin",
 
		"mobileserver_*" => "Mobile Admin",
		"mobileserver_?" => "Use this option below to setup your mobile app splash page and about us text",
		"mobileserver_^" => "sub",
...
$admin_layout_page01 = array(
	...
	"backup" => "Export Database",
		...
		"backup_?" => "Select one or more of the tables below to backup your database. It is strongly recommended that you use a 3rd party backup tool. See your dashboard for recommendation.",
...
$admin_layout_page2 = array(
	...
	"" => "Members A",
		...
		/*"tutor" => "Members B",
				...
				"tutor_*" => "Member B",
				"tutor_?" => "Use the options below to update a members B.",
				"tutor_^" => "none",*/
...
$admin_layout_page3 = array(
		...
		"" => "Template Gallery",
			...
			//"color" => "Color Schemes",
				...
				//"color_*" => "Color Schemes",
				"color_?" => "Using the options below you can customize the Color scheme for your web site. Only for older template styles. If you wish to replace images with your own, please use the theme image tools.",
				"color_^" => "sub",
			...
			"text" => "Home Page Text",
				...
				"text_?" => "Some templates have text boxes on the front page. The fields below allow you to change that welcome text. Some templates use different sets of wording pairs.",
				"text_^" => "sub",
	...
	"manager" => "File Manager",
		...
		"manager_?" => "The file manager is very useful when adding or deleting new files/content to your web site. You can browse the entire hosting account and delete files are required.",
			...
			"slider" => "Slider Images",
				"slider_$" => "half",
				"slider_*" => "Home Page Slider Images",
				"slider_?" => "Some templates have a front page slider. Use the options below to change those images, description and clickable links.",
				"slider_^" => "sub",
...
$admin_layout_page4 = array(
	...
	"template" => "Newsletter Templates",
		"template_$" => "half",
		"template_*" => "Newsletter Templates",
		"template_?" => "Listed below are a selection of newsletter templates built into the software. Click on any of the images to open and edit the template.",
		"template_^" => "sub",
	...
	"sendnew" => "Send Mass Emails",

		"sendnew_$" => "half",
		"sendnew_*" => "Send Emails",
		"sendnew_?" => "Use this section to begin sending emails to your members. First select which members to send to and then select which email to send.",
...
$admin_layout_page5 = array(
	...
	"" => "Membership Packages",
		...
		"_$" => "half",
		"_*" => "Membership Levels",
		"_?" => "Listed below are all the current membership packages applied to your web site. The ones highlighted are required by the system to control how visitors and new members are handled giving you more control of your web site.",

	"credits" => "Credits",

		"credits_$" => "half",
		"credits_*" => "Credits",
		"credits_?" => "Set the number of credits one email requires as well as the price for that credits.",
	...
	"upall" => "Upgrade Members",
		"upall_$" => "half",
		"upall_*" => "Upgrade Members Between Packages",
		"upall_?" => "Use this option is you wish to upgrade members from one membership level to another.",
		"upall_^" => "sub",
	...
	"billing" => "Member Payments",

		"billing_$" => "half",
		"billing_*" => "Member Payment Records",	

	"reports" => "Reports",
		"reports_$" => "half",
		"reports_*" => "Reports",
		"reports_?" => "Member Revenue Reporting",
		"reports_^" => "sub",
...
$admin_layout_page7 = array(
	...
	"" => "System Settings",
		...
		"_$" => "half",
		"_*" => "System Settings",
		"_?" => "Use the options below to turn off and on web site features that you do not want to use.",
	...
	"country_block" => "Country Blocking",

		"country_block_$" => "half",
		"country_block_*" => "Country Blocking",
		"country_block_?" => "Use this option to block whole countries from your website..",	
		...
		/*"op3" => "Flash Server Settings",
			...
			"op3_?" => "A flash server is used to store member video greetings.",
			"op3_^" => "sub",*/
...
$admin_layout_page8 = array(
	...
	"" => "Profile Questions",
		...
		"fieldlist_*" => "Drop Down Options",

		"fieldedit_*" => "Edit Titles",

		"fieldeditmove_*" => "Move field to another group",
		...
		"compatibilityaddfields" => "Create New Compatibility Field",
	
			"compatibilityaddfields_$" => "half",
			"compatibilityaddfields_*" => "Create New Compatibility Field",
			"compatibilityaddfields_?" => "Use the options below to add a new field to your web site. A field is used to allow members to fill out information about themselves.",
			"compatibilityaddfields_^" => "sub",
		...
		"compatibilityfieldgroups" => "Manage Compatibility Groups",
	
			"compatibilityfieldgroups_$" => "half",
			"compatibilityfieldgroups_*" => "Manage Compatibility Field Groups",
			"compatibilityfieldgroups_?" => "Groups are a collection of fields which have a common theme. So for example you may create a group called 'About me' and within the group add fields such as 'My Name', 'My Age' etc. <b>If you delete a group with fields in them, the fields will automatically be moved to the next group.",
			"compatibilityfieldgroups_^" => "sub",
		...
		"compatibilityaddgroups" => "Create New Compatibility Field Group",
	
			"compatibilityaddgroups_$" => "half",
			"compatibilityaddgroups_*" => "Create New Compatibility Field Group",
			"compatibilityaddgroups_?" => "A field group is a collection of fields all put under one main group headline. This enables you to create lots of groups with fields which are related to the group theme.",
			"compatibilityaddgroups_^" => "sub",
	...
	"class" => "Classifieds Admin",

		"class_$" => "half",
		"class_*" => "Classified Ads",
		...
		"addclasscat" => "Manage Categories",
			...
			"addclasscat_?" => "Use the options below to manage your classified ad categories. Its recommended to add a photo icon for each to make your web site look more professional.",
			"addclasscat_^" => "sub",
	...
	"compatibility" => "Compatibility Quiz",
		...
		"compatibility_?" => "Listed below are all the current fields listed on your web site. You can select to display the fields on the search page,registration pages, profile pages and even the member match pages. You can quickly and easily add new fields to your web site using the options",
...
$admin_layout_page10 = array(
	...
	"backup" => "Database Backup",
		...
		"backup_$" => "half",
		"backup_*" => "Database Backup",
		"backup_?" => "Select one or more of the tables below to bakup your database. It is strongly recommended that you use a 3rd party tool to backup your site. See our recommendation in the dashboard.",
...
$admin_layout_page11 = array(
	...
	"" => "Software Add-Ons",
		...
		"_$" => "half",
		"_*" => "Software Add-Ons",
		"_?" => "Add-Ons extend and expand the functionality of the dating software. Once a add-on is installed, you may activate it or deactivate it here using the menu options on the left.",
...
"12a" => "Dashboard",
"12b" => "Customers",
"12m" => "Payment Customers",
"12k" => "Members",
"12c" => "Approve Sites",
"12d" => "Approve Edits",
"12l" => "Profile Questions",
"12e" => "Approve Media",
"12f" => "Markets",
"12g" => "Reports",
"12h" => "Gateways",
...
"payment_customers_$" => "half",
"payment_customers_*" => "Payment Customers",
"payment_customers_?" => "",
"members" => "Members",
"members_$" => "half",
"members_*" => "Manage Members",
"members_?" => "",
"management" => "Profile Questions",
"management_$" => "half",
"management_*" => "Profile, Registration and Search Fields",
"management_?" => "Listed below are all the current fields listed on your web site. You can select to display the fields on the search page, registration pages, profile pages and even the member match pages. You can quickly and easily add new fields to your web site using the options below.",
"approve_sites" => "Approve Sites",
"approve_sites_$" => "half",
"approve_sites_*" => "Approve Sites",
"approve_sites_?" => "",
"approve_edits" => "Approve Edits",
"approve_edits_$" => "half",
"approve_edits_*" => "Approve Edits",
"approve_edits_?" => "",
"approve_media" => "Approve Media",
"approve_media_$" => "half",
"approve_media_*" => "Approve Media",
"approve_media_?" => "",
"markets" => "Markets",
"markets_$" => "half",
"markets_*" => "Markets",
...
$admin_help = array(
	...
	"10" => "This software allows you to manage all different aspects of your web site, including your members, files, security, email, add-ons, and a whole lot more.",	
...
$admin_plugins = array(
	...
	"1" => "Add-Ons extend and expand the functionality of our dating software. Once a plugin is installed, you may activate it or deactivate it here using the menu options on the left.",
	"2" => "You can view and download new software add-ons from the customer area of our web site.",
	"3" => "Plugin Name",
	"4" => "Plugin Details",
	"5" => "Last Updated",
	"6" => "Status",
...
$admin_settings_extra = array(
	...
	"14" => "Display Text Instant Messenger",
	...
	"48" => "Enable this option if you wish IM pop up's to open in a new window.",
	...
	"59" => "Country Blocking",
	"60" => "Use this option to block whole countries from your website.",
