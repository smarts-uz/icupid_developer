...
function ft_make_sidebar() {
	$str = '<div id="sidebar" class="sidebar_res">';
  // $status = '';
...
function ft_make_body() {
  ...
  // Make system messages.
    ...
    $str .= "<div id='status' class='hidden'></div>";
		...
		$str .= "<div id='status' class='intro' class='section'>{$status}</div>";
	}
	$str.= ft_make_sidebar();
