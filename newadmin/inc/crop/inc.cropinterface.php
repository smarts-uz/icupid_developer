...
height: auto;
    ...
    #cropInterface {
		...
		font-size: 10px;
		<?php if($this->getImageWidth() < 300){ ?> width:300px;<?php }else{ ?>
	...
	#cropResize,#cropSizes {
	backgrond-color:#EDFFE7;
	}
    ...
    #theCrop {
        ...
        border: 1px dashed #62AD46;
        background-image: url(<?=WEB_PATH_IMAGE.basename($this->file) ?>);
...
<div id="cropInterface">
    ...
    <div id="cropImage"><img src="<?=WEB_PATH_IMAGE.basename($this->file) ?>" alt="image" title="crop this image" name="theImage" id="theImage" /></div>
    
	<p>Hold down 'shift' while dragging to resize cropping area</p>
	...
	<div id="cropResize" style="display:none;">        
    ...
    <div id="cropSizes" style="display:none;">
