    ...
    */
    function buildMessage($params = array())
    {
        ...
        if (isset($message)) {
            ...
            $message_id = sprintf('<%s.%s@%s>', base_convert(time(), 10, 36), base_convert(rand(), 10, 36), !empty($GLOBALS['HTTP_SERVER_VARS']['HTTP_HOST']) ? isset($GLOBALS['HTTP_SERVER_VARS']['HTTP_HOST']) : isset($GLOBALS['HTTP_SERVER_VARS']['SERVER_NAME']));
