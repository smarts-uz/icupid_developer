...
function GetProfiles($pageGET, $This_Page, $getData=""){
	...
	$SHOW_ONLY_NETWORK =0; $NETWORK_ID=2; $NETWORK_SHOW_SQL=""; $MODdata['page'] ='mobileprofile';  $MODdata['sub'] ='overview'; $MODdata['type'] ='system';
	...
	$GLOBALS['LANG_SEARCH_INNER']['62'] = (isset($GLOBALS['LANG_SEARCH_INNER']['62'])) ? $GLOBALS['LANG_SEARCH_INNER']['62'] : '';
