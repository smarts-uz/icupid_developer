...
function inIframe () {
		...
		jQuery(document).ready(function(e) {
			   ...
			   jQuery("body").addClass("iframe-table");

   			   jQuery("body.iframe-table table td:first-child").attr("width",'65%');

   			   jQuery("body.iframe-table table td:first-child span:nth-child(2)").css("width",'65%');
...
require "layout.php"; 	
$check_template = D_TEMP;
if($check_template == "v17red")
{
?>
	<link rel="stylesheet" href="<?php echo DB_DOMAIN ?>inc/templates/v17red/template.css" type="text/css">
	<link rel="stylesheet" href="<?php echo DB_DOMAIN ?>inc/templates/v17red/style.css" type="text/css">
<?php
}
############################################################
...
elseif($action==''){
require($pathToFiles.'bb_func_vforum.php'); /*Content of Forum*/
