...
function GetTopicData($id){
	...
	$result = mysqli_query($GLOBALS['varr'],"SELECT post_text  FROM forum_posts  WHERE topic_id =".$id." LIMIT 1") or die("no db selected");
...
function GetTopicTitle($id){
	...
	$result = mysqli_query($GLOBALS['varr'],"SELECT topic_title,topic_poster   FROM forum_topics WHERE topic_id =".$id." LIMIT 1") or die("no db selected");
	$row = mysqli_fetch_row($result);
...
function GetTopicOwner($id){
	...
	$result = mysqli_query($GLOBALS['varr'],"SELECT topic_poster FROM forum_topics WHERE topic_id =".$id." LIMIT 1") or die("no db selected");
	$row = mysqli_fetch_row($result);
...
function GetPhoto($id, $type){
	...
	$result = mysqli_query($GLOBALS['varr'],"SELECT id, title, bigimage, approved FROM files WHERE uid=".$id." AND  type='photo' AND `default`=1 LIMIT 1") or die("no db selected");
