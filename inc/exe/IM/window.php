...
<div class="im_wrapper">
    ...
    <div id="im_sidebar" style=" overflow:hidden;">
            ...
            <div id="ShowWebCam" style="display:none;">
                      ...
                      <div id='preview'></div>
                        ...
                        <script type='text/javascript' src='<?=$subd ?>inc/js/swfobject.js'></script>
                          ...
                          var s1 = new SWFObject('<?=$subd ?>inc/exe/flash/video_player_rtmp.swf','ply','100%','100%','9','#ffffff');
        ...
        <div class="panel"><a href="javascript:void(0)" onClick="toggleLayer('p2'); ChangeLiveStatus(<?=$_SESSION['uid'] ?>); return false;">&nbsp;&nbsp;&nbsp;   Enable / Disable Webcam</a></div>
            ...
            <SCRIPT language="JavaScript">
                ...
                displayeMeeting("<?=$subd ?>inc/exe/flash/video_streamer.swf?&uid=<?=$_SESSION['uid'] ?>&userid=77","100%","100%",{ menu:"false",bgcolor:"#FFFFFF",version:"6,0,47,0",align:"middle"});
