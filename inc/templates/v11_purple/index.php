...
.menu {   background: #716082 url('../../../inc/templates/v11_purple/images/menu_bg.jpg') no-repeat; height:60px; margin:0px; padding:0px; }
ul.tabs{ float:left; }
div#PageHeader {     background-color: transparent; }
.sub_tabs li a span { color:#fff;}
.onlinenow a {
    color: #cccccc;
    font-size: 12px;
}
...
#bottomBar {
    background: #907FA2 url('../../../inc/templates/v11_purple/images/bottom.jpg') bottom no-repeat;
}
#bottomBar .col1 {
    width: 33% !important;
    float: left;
