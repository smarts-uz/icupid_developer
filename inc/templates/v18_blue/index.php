...
<h2 class="heading"><?=$LANG_BODY['_member']. " ".$LANG_BODY['_search'] ?></h2>
<table class="member-info-table" width="320"  border="0" cellpadding="0" cellspacing="0" >
...
<input type="submit" name="submit" value="&nbsp;&nbsp;<?=$LANG_BODY['_search'] ?>&nbsp;&nbsp;" class="NormBtn" >
</td>
</tr>
</table>
</form>
...
<p><a href="index.php?dll=login" style="color:white;"><?=$LANG_WELCOME['_join2'] ?></a></p>
 ...
 <?php */?>
 <style>
 	/*body #MainPageBackground div.page_header{
		float:none;
		width:70%;
	}*/
	#ImageLogo {
		background-image: url('/uploads/files/logo_index_v18_blue.png');
	}
	.wide_wrapper {
		position: initial;
		top: 0;
	...
	.footer_sec {
		-moz-box-shadow:none;
		/* -webkit-box-shadow: 0 -2px 6px #c1c1c3; */
		-khtml-box-shadow: none;
		/* box-shadow: 0 -5px 6px #c1c1c3; */
		box-shadow:none;
	}
