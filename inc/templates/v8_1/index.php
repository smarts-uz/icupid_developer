...
.menu {  margin-left:0; background: #325386 url('../../../inc/templates/v8_1/images/menu_bg.jpg') repeat-x;border-top:2px solid white; }
.page_header { 	
	background: #EAF3FA url('../../../inc/templates/v8_1/images/header.jpg') repeat-x;  border:1px solid white; 
}
div#page_footer .content-width {
    WIDTH: 940PX;
    MARGIN: 0 AUTO;
}
...
<table width="915" height="476" border="0" style="margin-left:10px;"><tr><td width="244" height="19" valign="top">
		  ...
		  <tr>
			<td height="145" valign="top"><form method="post" action="index.php">
              ...
              <table width="100%"  border="0" style="margin-top:10px;">
                ...
                <tr>
                  <td colspan="2" style="color:;"><input name="submit" type="submit" class="NormBtn" value="<?=$GLOBALS['_LANG']['_login'] ?>" style="color:#333;>
	...
	<div style="background: transparent url('inc/templates/<?=D_TEMP ?>/images/h4.jpg') top right; background-repeat:no-repeat; height:240px; margin-left:15px;">
		...
		<div style="width:360px;display:block; margin-top:20px;">
			...
			<input type="button" value="&nbsp;&nbsp;<?=$LANG_WELCOME['_join2'] ?>&nbsp;&nbsp;" class="MainBtn" onClick="location.href='index.php?dll=register'" style="font-size:16px;color:#333;">&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" value="&nbsp;&nbsp;<?=$LANG_TOUR['a1'] ?>&nbsp;&nbsp;" class="MainBtn" onClick="location.href='index.php?dll=tour'" style="font-size:16px;color:#333;">
