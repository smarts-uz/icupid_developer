...
.menu {   background: #537136 url('../../../inc/templates/v11_green/images/menu_bg.jpg') no-repeat;HEIGHT: 60PX;}
#bottomBar .col1 {
    width: 33%;
}
#bottomBar .col2 {
...
#bottomBar{ background:#759558 url('../../../inc/templates/v11_green/images/bottom.jpg') bottom no-repeat;}
</style>
...
<input type="submit" name="submit" value="&nbsp;&nbsp;<?=$LANG_BODY['_search'] ?>&nbsp;&nbsp;" class="NormBtn"  style="font-size:16px;color: #222;">
</td></tr>
