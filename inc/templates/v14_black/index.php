...
.inner {
    ...
    background: #505050;
    box-shadow: 0px 1px 16px 2px #767676;
    margin-right: 25px;
}
ul.flags_ul li {
...
<div class='row' style="background: url('<?=DB_DOMAIN ?>/inc/templates/<?=D_TEMP ?>/images/index_backdrop.jpg') top repeat-x #0c0c0c;margin:0px;padding:0px;">
