...
.menu, .sub_menu,#page_footer, #copyright_bar { width:940px; text-align: center; margin: 0px auto;   } 
.page_header,#page_container { width: 940px;}

.menu {
    margin-left: 0;
    background: #000000 url('../../../inc/templates/v5_6/images/menu_bg.jpg') repeat-x;
