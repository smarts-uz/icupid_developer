...
.menu { background: #666666 url('../../../inc/templates/v9_1/images/menu_bg.jpg') repeat-x; }
#page_footer .footer_menu { 	background: #8E4C56; margin-bottom:0px;}
#bottomBar .col1 {
    width: 33%;
}
#bottomBar .col2 {
...
#bottomBar{	color: #fff; background: #67212C; border-top:1px solid #8E4C56;}
.page_header { 	
	background: transparent url('../../../inc/templates/v9_1/images/header.jpg') top center no-repeat;
}
/* MAIN CONTAINER, SITES UNDER THE HEADER */ 
#page_container { 
 
	 background: #ffffff url('../../../inc/templates/v9_1/images/header_bottom.jpg') no-repeat; 
}
#ImageLogo { margin-left:25px; margin-top:15px;}
ul.tabs {
    float: left;
}
#copyright_bar {
...
<a href="index.php?dll=register" class="NormBtn" style="width:65px; height:60px; display:block; margin-left:4px; margin-top:20px;line-height:20px;">  
