...
{ 
	 // your secret key
	$secret = "6LflHhATAAAAAAZi3WL30mooDBOEIByaS2NEr_jR";
	 
	// empty response
	$response = null;
	//echo "Response is ".$_POST["g-recaptcha-response"];
	...
	if ($_POST["g-recaptcha-response"]) {
		...
		if ($response != null && $response->success) {
		  ...
		  {
			  $ERROR_MESSAGE = "Invalid Verification Code (reenter captcha code)" ;
			  $ERROR_TYPE = "bad";
...
<div id="MainPageBackground">
    ...
    <div <?php if($page != "index"){?> class="navbar navbar-inverse navbar-fixed-top"<?php }?> >
		<div class="page_header" id="PageHeader">
            ...
            <!--4-->
                ...
                <form class="f_left">
                    <select class="language f_left padding_5" name="lang" id="lang" onchange="location = this.options[this.selectedIndex].value;"> 
                     ...
                     <? if(my_logged_in){ ?>
					 <? }elseif($page == "index"){ ?>
                        <a href="/index.php?dll=login" style="text-decoration:none; background-color:white; margin-left:18px; padding: 5px 14px; line-height: 30px;">
                            Login Here
                        </a>
                    <? } ?>
            ...
            <div <?php if($page == "index"){?> class="menu"  style=" margin:21px 20px 0px 0px;"<?php } ?>  id="MenuBar"><!--3-->
