...
.page_header { 	
	background: #ffffff url('../../../inc/templates/v8_4/images/header.jpg') repeat-x;  border:1px solid white; 
}
/* MAIN CONTAINER, SITES UNDER THE HEADER */ 
#page_container { 
	 background: white; display:block; border:1px solid white;
}
#main_content_wrapper { 
background: transparent url('../../../images/body_wrapper_top.jpg') top left no-repeat; ;
}
.menu { background: #FFE6E9 url('../../../inc/templates/v8_4/images/menu_bg.jpg') repeat-x;border-top:2px solid white;}

body{ background: #CB6597 url('../../../inc/templates/v8_4/images/bg.jpg') repeat-x;}
.content-width {
    width: 940px;
    margin: 0 auto;
}
