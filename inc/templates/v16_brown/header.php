...
.login{width:100px;line-height:24px; background-color:#fff; float:right; margin-left:10px; border:1px solid grey;}
.login:hover{background-color:#da4c66; color: white;  }
.language{width: 100px; height: 25px; background-color: #fff; border-color:grey;}
.language:hover{background-color: #da4c66; color: white; border-color:#da4c66;}
...
<div <?php if($page !='index'){?> class="right-head" <? }?> class="index_lang"><!--5-->
<?php
...
<? if($page == "index"){ ?>
<div class="login" ><!--4-->
<a href="/index.php?dll=login" style="text-decoration:none; margin-left:18px;" >Login Here</a>
</div><!--4--><? } ?>
...
<?php } ?>
<div class="menu" id="MenuBar" style=" <?php if($page == "index"){?> margin:0px 20px 0px 0px; <?php } ?>">
                <ul class="tabs">
				<?=$HEADER_MENU_BAR_TOP ?>
				</ul>
        </div>
