...
<style>
#splitpage #main_content_wrapper { background: #ffffff; border:0px;}#splitpage #main_wrapper_bottom {	background: #ffffff;}
#main_content_wrapper { 
  background: white url('../../../inc/templates/v11_red/images/main_wrapper.jpg') top left no-repeat;
}
#bottomBar{	
background: #DA7D7D url('../../../inc/templates/v11_red/images/bottom.jpg') bottom no-repeat;}
#bottomBar .col1 {
    width: 33%;
}
#bottomBar .col2 {
...
#page_footer .footer_tabs li a { color: #444444; }
.menu {   background: #BC4E4D url('../../../inc/templates/v11_red/images/menu_bg.jpg') no-repeat; height:60px;}
#copyright_bar { background:#F7EBDD;}
...
<tr>
  <td height="28"><?=$LANG_BODY['_country'] ?></td><td>
<? print '<SELECT name="SeV[1]"  style="width:95%" id=country onchange="eMeetingLinkedField(this.value, 54,100003);" >';print DisplayCountries("",true); ?>
</td></tr>
...
<tr>
  <td height="28"><?=$LANG_BODY['_province'] ?></td><td>
<? print '<div id="Link54" valign="top"><SELECT name="SeV[3]"  style="width:95%" id=country>'; ?>
</td></tr>
...
<input type="submit" name="submit" value="&nbsp;&nbsp;<?=$LANG_BODY['_search'] ?>&nbsp;&nbsp;" class="NormBtn"  style="font-size:16px;color:#000">
</td></tr>
