...
.menu { background: #8F111D url('../../../inc/templates/v8_3/images/menu_bg.jpg') repeat-x; border-top:2px solid white; }
.page_header { 	 border:1px solid white;  
}
ul.tabs { float:left; }
...
#page_footer .content-width{ width: 940px; margin: 0 auto; }
</style>

<div class="ClearAll"></div>
<table width="915" height="476" border="0" style="margin-top:10px; margin-left:7px;"><tr><td width="244" height="19" valign="top">
