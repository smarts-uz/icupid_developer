...
#PageHeader .navbar-inverse {
     background-color: #08afec; 
     border: 0; 
}
...
<div id="MainPageBackground">
  ...
  <div <?php if($page != "index"){?> class="navbar navbar-inverse navbar-fixed-top"<?php }?> >
    ...
    <div class="page_header" id="PageHeader">
      ...
      <?php if($page != "index"){?><div id="top_banner"><? foreach($BANNER_ARRAY as $banner){ if($banner['position'] =="top"){ print $banner['display'];}} ?></div><?php }?>
  ...
  <div <?php if($page != "index"){?> class="wide_wrapper" <?php } ?>>
    ...
    ?>
      ...
      <div id="header-section-13" class="header-section-boxed">
	...
	<?php
      ...
      ?>
      <div id="featured_members" class="featured_members_boxed">
