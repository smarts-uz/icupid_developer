...
.menu { background: #666666 url('../../../inc/templates/v9/images/menu_bg.jpg') repeat-x; }

.page_header { 	
	background: transparent url('../../../inc/templates/v9/images/header.jpg') top center no-repeat;
}
#copyright_bar { background:#314450; text-align:center;}
#ImageLogo { margin-left:25px; min-height:77px;}
#bottomBar{
	background: #E54538;
...
.tabs li .selected {
    background: #ffffff url('../../../inc/templates/v9/images/menu_selected.jpg') no-repeat bottom left;
    color: #E54538;
}
    ...
    <td width="273" valign="top"><table width="273" height="180"  border="0" cellspacing="6" bgcolor="#FFFFFF" style="border:1px solid #cccccc;">
      <tr>
        <td width="257" height="168" valign="top"><table width="100%"  border="0" cellpadding="0">
          <tr>
            <td width="272" height="35" class="inner_nav_bar">&nbsp;&nbsp;<?=$GLOBALS['_LANG']['_login'] ?></td>
          </tr>
          <tr>
