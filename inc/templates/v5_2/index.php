<?php  $fdata = DisplayFeaturedMembers(12); ?>
<style>
#splitpage #main_content_wrapper { background: transparent; border:0px;}
#splitpage #main_wrapper_bottom {	background: transparent;}
#copyright_bar { border-right:0px; text-align: center !important; }
.menu, .sub_menu,#page_footer, #copyright_bar {  } 
.page_header,#page_container { width: 940px;}
.menu {
    background: #75214B url('../../../inc/templates/v5_2/images/menu_bg.jpg') repeat-x;
...
<script type="text/javascript">
		var so = new SWFObject("inc/templates/<?=D_TEMP ?>/images/banner.swf", "slideshow", "350", "80", "0", "#F3479F");
