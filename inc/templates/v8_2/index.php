...
.menu {background: #5E5278 url('../../../inc/templates/v8_2/images/menu_bg.jpg') repeat-x;border-top:2px solid white; }
#page_footer .footer_menu {background: #5E5278;border:1px solid #fff;width:938px;}
.content-width {
    width: 940px;
    margin: 0 auto;
}
