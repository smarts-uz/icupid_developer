...
.login-box ul li .input{margin: 2px 10px;padding: 5px; width: 100%;}
.login-box ul li .blue-btn{ background: #9f1a13; color: #fff; border: 1px solid #9f1a13; border-radius: 4px;padding: 4px 10px 6px 10px;}
.login-box ul .forget-txt a,.remember-me-txt{text-decoration: none;color: #9f1a13;color: #c3c3c3;line-height:35px;}
...
.home_age .col-md-4 select {width: 100%; height: 32px; padding: 5px;}
...
<div class="page_header">
         ...
         <? if(!my_logged_in){ ?>
            ...
            <? */} ?>
                ...
                <li class="remember-me-txt col-xs-12 col-sm-4 col-md-2 col-lg-2"><input type="checkbox" name="remember" value="1" style="margin-right:4px;" checked='checked'><?=$GLOBALS['_LANG']['_rememberMe']  ?></li>
                ...
                <li class="forget-txt col-xs-12 col-sm-4 col-md-3 col-lg-3"><a href="#" onclick="toggleLayer('ForgottenPassword'); return false;"><?=$GLOBALS['LANG_COMMON'][1] ?></a></li>
                <? if (defined('FACEBOOK_APP_ID')  && FACEBOOK_APP_ID !="") {/* ?>  
    ...
    <div class="menu hidden-xs hidden-sm hidden-md hidden-lg" id="MenuBar"><!--3-->
...
<div class="default-img">
  <div class="register-form">
     <form method="post" name="MemberSearch" id="MemberSearch" action="<?=DB_DOMAIN ?>"  style="margin:0px;">
