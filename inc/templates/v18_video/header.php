...
<div id="MainPageBackground">
	...
	<div <?php if($page != "index"){?> class="navbar navbar-inverse navbar-fixed-top"<?php }?> >
		<div class="page_header" id="PageHeader">
           ...
           <div class="right-head" style=" <?php if($page == "index"){?> margin:21px 20px 0px 0px; <?php } ?>"><!--5-->
				<?php
           ...
           <?php if($page != "index")
			...
			<div class="menu" id="MenuBar" style=" <?php if($page == "index"){?> margin:21px 20px 0px 0px; <?php } ?>"><!--3-->
                <ul class="tabs">
                    <?=$HEADER_MENU_BAR_TOP ?>
                </ul>
			</div><!--3-->
