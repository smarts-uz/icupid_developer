...
<div id="MainPageBackground">
	...
	<?php if($page=='index'){ ?><div class="top-menu"><? } ?>
				 ...
				 ?>
	                <div class="logo_height">
	                    <a href="<?=DB_DOMAIN ?>index.php" title="<?=$HEADER_META_TITLE ?>">
	                        <div id="ImageLogo">					
	                            <p class="<?php if( TMP_LOGO_ICON =="images/DEFAULT/LOGOS/none.png"){ print "p3"; }else{ print "p1"; } ?>"><? if(TMP_LOGO_HIDE ==0){ ?><?=TMP_LOGO ?><? } ?></p>					
	...
	<div class="right-head index_right"><!--5-->
	<?php
		if(isset($_REQUEST['l'])){
