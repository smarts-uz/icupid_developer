...
.menu {   background: #24C1E4 url('../../../inc/templates/v11/images/menu_bg.jpg') no-repeat; height:60px;}
#bottomBar{	
background: #0FB9F6 url('../../../inc/templates/v11/images/bottom.jpg') bottom no-repeat;}
#page_footer .footer_menu {background: #333;}
#copyright_bar a {
    color: #666666;
}
#bottomBar h4{ 	background-color: #353639;}
#bottomBar .col1 {
    width: 33%;
}
#bottomBar .col2 {
