...
<link rel="shortcut icon" href="<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/favicon.ico" />
 ...
 <link href="<?php echo DB_DOMAIN?>/inc/templates/<?=D_TEMP ?>/css/bootstrap.css" rel="stylesheet">
<!-- bootstrap -->
<link href="<?php echo DB_DOMAIN?>/inc/templates/<?=D_TEMP ?>/css/bootstrap-rtl.min.css" rel="stylesheet" type="text/css" />
...
<!-- rtl style -->
<link href="<?php echo DB_DOMAIN?>/inc/templates/<?=D_TEMP ?>/css/rtl.css" rel="stylesheet" type="text/css" />
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12"> 
              <!-- menu logo -->
              <ul class="menu-logo">
                  <li> <a href="<?php echo DB_DOMAIN; ?>"><img src="<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/logo.png" alt="logo" /> </a> </li>
              </ul>
              <!-- menu links -->
              <ul class="menu-links">
                  <?=$HEADER_MENU_BAR_TOP ?>
               ...
               <ul style="overflow-y: scroll;padding-left:93px !important;direction: ltr;" id="mainNevigationBar"  class="navbar-nav navbar-right " data-type="navbar">
            <?=$HEADER_MENU_BAR_TOP ?>
...
<section id="home-slider" class="fullscreen">
  <div id="main-slider" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner"> 
      <!--/ Carousel item end -->
      <div class="carousel-item active h-100 bg-overlay-red " style="background: url(<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/bg/bg-1.jpg ) no-repeat 0 0; background-size: cover;">
        <div class="slider-content">
          <div class="container">
            <div class="row carousel-caption justify-content-center align-items-center h-100">
      ...
      <div class="carousel-item h-100 bg-overlay-red" style="background: url(<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/bg/bg-2.jpg ) no-repeat 0 0; background-size: cover;">
        <div class="slider-content">
          <div class="container">
            <div class="row carousel-caption justify-content-center align-items-center h-100">
...
<section class="form-1 py-3">
    <form id="frmSearch" method="POST" action="<?php echo DB_DOMAIN?>search">
         
        <input type="hidden" id="seeking" name="SeV[1]" value="" />
        <input type="hidden" id="ddfrom" name="Extra[age1]" value="" />
        <input type="hidden" id="ddto" name="Extra[age2]" value="" />
  ...
  <div class="container">
    <div class="banner-form">
      <div class="row justify-content-center">
        ...
        <div class="col-md-3">
          <div class="form-group row">
            ...
            <div class="col-lg-7 col-md-12">
                <div class="dropdown-big">
                    <select id="ddseeking" name="ddseeking">
        ...
        <div class="col-md-2"><a id="searchSubmit" class="button btn-lg btn-theme full-rounded animated right-icn"><span>search <i class="glyph-icon flaticon-hearts" aria-hidden="true"></i></span></a></div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center" >
      <div class="col-md-2 text-center">
        <div class="counter"> <img src="<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/counter/01.png" alt="" /> 
            <span class="timer" data-to="<?php echo $totalmembers;?>" data-speed="10000"><?php echo $totalmembers;?></span>
          <label>Total Members</label>
        </div>
      </div>
      <div class="col-md-2 text-center">
        <div class="counter"> <img src="<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/counter/02.png" alt="" />
            <span class="timer" data-to="<?php echo $TotalOnline; ?>" data-speed="10000"><?php echo $TotalOnline; ?></span>
          <label>Online Members</label>
        </div>
      </div>
      <div class="col-md-2 text-center">
        <div class="counter"> <img src="<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/counter/03.png" alt="" /> 
      ...
      <div class="col-md-2 text-center">
        <div class="counter"> <img src="<?php echo DB_DOMAIN?>inc/templates/<?= D_TEMP ?>/images/counter/04.png" alt="" /> 
        ...
        <div class="owl-carousel" data-nav-arrow="true" data-items="4"  data-lg-items="4" data-md-items="3" data-sm-items="2"  data-space="30">
            ...
            <div class="profile-image clearfix">
              <img class="img-fluid w-100" src="
                  <?php echo $value['image'] ?>"  alt="<?=$value['username'] ?>" /></div>
...
<section class="page-section-ptb grey-bg">
  <div class="container">
    <div class="row justify-content-center mb-5 sm-mb-2">
      ...
      <?php
     $show_blog_array= DisplayRecentBlogs(2);
