...
{?>
    <body  <?=$HEADER_ON_LOAD ?>>
<?php }
else if(isset($HEADER_SINGLE_COLUMN)){ ?>
...
?>
    ...
    <!--<div <?php if($page != "index"){?> class="navbar navbar-inverse navbar-fixed-top"<?php }?> >
		<div class="page_header" id="PageHeader">
			 ...
			 ?>
                <div class="logo_height">
                    <a href="<?=DB_DOMAIN ?>index.php" title="<?=$HEADER_META_TITLE ?>">
                        <div id="ImageLogo">					
                            <p class="<?php  if( TMP_LOGO_ICON =="images/DEFAULT/LOGOS/none.png"){ print "p3"; }else{ print "p1"; } ?>"><?php  if(TMP_LOGO_HIDE ==0){ ?><?=TMP_LOGO ?><?php  } ?></p>					
                            <p class="p2"><?php  if(TMP_LOGO_HIDE ==0){ ?><?=TMP_LOGO_SLOGAN ?><?php  } ?></p>
                        </div>
                    </a>
                </div>
            ...
            <div class="right-head" style=" <?php if($page == "index"){?> margin:21px 20px 0px 0px; <?php } ?>">
                ...
                <?php  if (defined('FACEBOOK_APP_ID')  && FACEBOOK_APP_ID !="") { ?>             
                <li>
                ...
                <li><div class="line-txt"><span>or sign in below</span></div></li>    
                        <li><input placeholder="<?=$GLOBALS['_LANG']['_username'] ?>" tabindex="1" maxlength="15" name="username" id="e_username" type="text" class="input" size="25" <?php  if(isset($_COOKIE['emeeting']['username'])){ print "value='".$_COOKIE['emeeting']['username']."'"; } ?>>
                        </li>
                    ...
                    <div style="display:none" id="ForgottenPassword2">	
                        ...
                        <div class="CapBody"><li>Enter your registration email<br /> and we'll send your a password</li>
                            ...
                            <?php /*?><?php  if(D_REGISTER_IMAGE ==1){ ?><li><label	><?=$GLOBALS['_LANG']['_verification'] ?>:</label> <input maxlength="15" type="text" name="code" id="C4" class="input"><br><img name="Verification Image" src="<?=DB_DOMAIN ?>inc/classes/class_regimg_img.php?regen=y&<?php  echo time(); ?>"></li><?php  } ?><?php */?>
			 ...
			 {
			 ?>
                <div id="top_banner" class="hiddenonsmall"><?php  foreach($BANNER_ARRAY as $banner){ if($banner['position'] =="top"){ print $banner['display'];}} ?></div>	 
            <?php
             }
            ?>
            ...
            <div class="" id="MenuBar" style=" <?php if($page == "index"){?> margin:21px 20px 0px 0px; <?php } ?>"> 
    ...
    <div <?php if($page != "index"){?> class="wide_wrapper" <?php } ?>>
		...
		<?php $fdata = DisplayFeaturedMembersTop(24,1); ?>
