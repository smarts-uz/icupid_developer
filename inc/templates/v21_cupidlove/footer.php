...
<link href="inc/templates/v21_cupidlove/bxslider2/jquery.bxslider.css" rel="stylesheet" type="text/css" /> 
<script>
...
//echo $page.'  --- <br>'.$_SESSION['auth'].'  --- $_SESSION[auth]';
...
{
     if($page!="index") // dosn't display footer for guest home page
    {
