...
<div id="messages">
      <div class="message-bad" id="main-message-bad" style="display: none;">
      	<a class="dismiss-message" href="javascript:void(0);" onclick="$(this).parent().fadeOut('slow');"><img src="images/DEFAULT/_icons/16/menu.gif"></a>
				...
				<div id="MainRegisterForm" class="registration-container">
					...
					<div id="reg_step_1">
						...
						<div class="row">
								...
								<p class="note" id="response_searchnext"  style="display: none;"></p>
						...
						<div class="row">
							...
							<div class="col-md-6">
									...
									<div class="form-group text-right">
										<a href="javascript:void(0);" onclick="var result = runRegistrationValidation('cslide-slides','<?=DB_DOMAIN?>'); return result;" class="MainBtn pull-right" style="padding:8px;">Continue</a>
