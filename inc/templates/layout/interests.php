...
<div id="eMeeting" class="user">
  <div class="header account_tabs">
    <ul>
	 	<li><a href="<?= getThePermalink('interests/manage') ?>"><span>Search Interests</span></a></li>

	 	<li <? if($show_page=="manage"){ ?>class="selected"<? } ?>><a href="<?= getThePermalink('interests/manage') ?>"><span><?=$LANG_GROUPS_MENU['manage'] ?></span></a></li>
		<li <? if($show_page=="add"){ ?>class="selected"<? } ?>><a href="<?=getThePermalink('interests/add')?>"><span><?=$LANG_GROUPS_MENU['add'] ?></span></a></li>
    </ul>
...
.search_display_featured { background:#FFF8DD url('images/DEFAULT/featured.jpg') no-repeat bottom right; }
	...
	<div id="Title">
		<div class="AddIcon"><br><a href="<?= getThePermalink('interests/add') ?>" class="MainBtn">  <img src="<?=DB_DOMAIN ?>images/DEFAULT/_acc/add.png" align="absmiddle"> <?=$GLOBALS['_LANG']['_createNew'] ?></a></div>
	...
	<div class="result_not_found"><h1><a href="<?= getThePermalink('interests/view') ?>"> <?=$GLOBALS['_LANG_ERROR']['_noResults'] ?></a></h1></div>
	...
	<img src="<?=DB_DOMAIN ?>images/DEFAULT/_icons/new/pencil.png" width="16" height="16" align="absmiddle"> <a href="<?= getThePermalink('interests/add/'.$value['id']) ?>"> <?=$GLOBALS['_LANG']['_edit'] ?> </a> <br>
...
<p><strong><?=$GLOBALS['_LANG']['_username'] ?>:</strong><span> <a href="<?= getThePermalink('user', array('username' => $info_array['username'])) ?>"><?=$info_array['username'] ?></a></span></p><hr>
