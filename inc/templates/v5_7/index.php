...
#copyright_bar { border-right:0px; }
.menu, .sub_menu { width:940px; margin-left:0px; margin-right:0px;   } 
.page_header { width: 940px;}

body .container_wrapper #page_container{
	background:none !important;
}
body{
	background: #000000 url('../../../inc/templates/v5_7/images/bg.gif') top center no-repeat;
...
.menu {
    background: #000000 url('../../../inc/templates/v5_7/images/menu_bg.jpg') repeat-x;
...
#copyright_bar , #page_footer.footer_sec{
...
<table width="880"  border="0" style="margin-left:10px; margin-top:0px; margin-bottom:10px;">
  <tr>
    ...
    <div style="padding:8px;background: #fff;"><b><?=$GLOBALS['_LANG']['_searchQ'] ?></b> </div>
	...
	<div style="padding:8px;background: #fff;"><b><?=$GLOBALS['LANG_WELCOME']['_join'] ?></b>  <a href="index.php?dll=register"><?=$GLOBALS['LANG_WELCOME']['_join2'] ?></a> </div>
...
<table width="350" height="268"  border="0" cellspacing="6" bgcolor="#FFFFFF" style="border:1px solid #cccccc; margin-top:10px;">
  <tr>
    <td height="254" valign="top" style=" background-color:#fff;"><table width="100%"  border="0" cellpadding="0">
        <tr>
          <td width="272" height="35" class="inner_nav_bar" style="">&nbsp;&nbsp;<?=TMP_TXT_1 ?></td>
        </tr>
        <tr>
          <td height="209" valign="top" class="inner_nav_body" style="line-height:27px; ">&nbsp;<?=TMP_TXT_4 ?>
            </td>
        </tr>
    </table></td>
  </tr>
...
<script type="text/javascript">
		var so = new SWFObject("inc/templates/<?=D_TEMP ?>/images/banner.swf", "slideshow", "350", "80", "0", "#000000");
