...
.menu, .sub_menu,#page_footer, #copyright_bar { width:940px; margin:0px auto; } 
.page_header,#page_container { width: 940px;}
.footer-banner-add{ display:none;}
.menu {
    background: #666666 url('../../../inc/templates/v5_8/images/menu_bg.jpg') repeat-x;
...
<script type="text/javascript">
		var so = new SWFObject("inc/templates/<?=D_TEMP ?>/images/banner.swf", "slideshow", "350", "80", "0", "#424242");
