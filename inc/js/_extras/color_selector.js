...
function getColor(coloridbox) {
	...
	var ThisPlugin = document.getElementById('plugin');
	 if (ThisPlugin.style.display == 'block' || ThisPlugin.style.display=='')
    {
        ThisPlugin.style.display = 'none';
    }
    else 
    {
        ThisPlugin.style.display = 'block';
    }
