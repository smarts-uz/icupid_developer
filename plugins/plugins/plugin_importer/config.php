<?php
	$openinviter_settings=array(
		"username"=>"emeeting",
		"private_key"=>"5a126bc33f721fca949c5cbd2f9f34cd",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to join a website", // website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to join this website", // the website on your account. If wrong, please update your account at OpenInviter.com
